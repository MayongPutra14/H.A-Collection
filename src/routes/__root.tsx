...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Curated hijabs and abayas for the modern woman. Anggun. Sopan. Elegan." },
      { property: "og:title", content: "H.A Collection" },
      { property: "og:description", content: "Curated hijabs and abayas for the modern woman." },
